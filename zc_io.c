...
const char* zc_read_start(zc_file* file, size_t* size) {
  ...
  fprintf(stderr, "hello 2 world\n");

  int currPageIndex = (int)ceil((double)file->offset / pageSize);
  fprintf(stderr, "hello 3 world\n");
